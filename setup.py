...
def print_next_steps():
    ...
    print("2. 🧪 Test the system: python -m src.lineup_tracker.async_main test")
    print("3. 🚀 Start monitoring: python -m src.lineup_tracker.async_main run")
    print()
    print("Useful commands:")
    print("• Export dashboard data: python -m src.lineup_tracker.async_main export")
    print("• Check system status: python -m src.lineup_tracker.async_main status")
